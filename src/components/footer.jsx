...
const Footer = () => {
  return <footer className="relative h-50 pt-15 " >
    ...
    <div className='flex justify-center bg-main-primary ' >
      <p class="text-base tracking-wide lg:text-xl md:text-xl text-main-background flex items-center ">Made with
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 heart px-0.5 ">
