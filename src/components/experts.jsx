...
const Experts = () => {
  return (
    <section className="w-full mt-20 px-6 flex flex-col items-center">
      {/* Heading */}
      ...
      <div className="mt-12 flex flex-col lg:flex-row gap-8 w-full max-w-6xl">
        ...
        <div className="bg-white shadow-md rounded-2xl p-6 flex-1">
          <div className="flex flex-col items-center">
            <div className="relative">
              ...
              />
              <p className="absolute left-2.5 top-[89px] bg-cyan-800 rounded-lg text-white text-[10px] px-3 py-1">
                NMC No: 6395
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="bg-gray-50 p-3 rounded-lg text-center">
              <img src="/graduation-hat.png" className="w-6 h-6 mx-auto mb-2" alt="" />
              <h4 className="font-semibold">MBBS, MD</h4>
              <p className="text-sm text-gray-500">Kathmandu University</p>
            </div>
              <div className="bg-gray-50 p-3 rounded-lg text-center">
              <img src="/award.png" className="w-6 h-6 mx-auto mb-2" alt="" />
              <h4 className="font-semibold">NESOG Logic Gold Medal</h4>
              <p className="text-sm text-gray-500">Excellence Award 2013</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg text-center">
              <img src="/heart.png" className="w-6 h-6 mx-auto mb-2" alt="" />
          ...
          <div className="mt-6 bg-gray-100 rounded-xl p-3 text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button className="border border-cyan-800 rounded-lg py-2 font-semibold hover:bg-cyan-50">
              Learn More About Dr. Subha
            </button>
            <button className="bg-cyan-800 text-white rounded-lg py-2 font-semibold hover:bg-cyan-900">
              Book Consultation
            </button>
          </div>
        </div>
        ...
        <div className="bg-white shadow-md rounded-2xl p-6 flex-1">
          ...
          <ul className="space-y-3 text-gray-700">
            <li>✔ Nepal Medical Council Registered Specialist</li>
            <li>✔ NESOG Logic Gold Medal Winner (2013)</li>
            <li>✔ Certified IVF Fellowship from Indira IVF, India</li>
            <li>✔ Over 10 years of clinical experience</li>
            <li>✔ Advanced training in reproductive health</li>
            <li>✔ Compassionate, ethical practice approach</li>
          </ul>
        </div>
      </div>
    </section>
